 ...
 */
final class Version20230116162130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT NOT NULL, telephone VARCHAR(25) NOT NULL, adresse VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD telephone VARCHAR(25) DEFAULT NULL, ADD adresse VARCHAR(25) DEFAULT NULL');
    }
}
